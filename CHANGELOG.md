...
- Add bufferline colors to multiple themes (#3881)
- Add `gruvbox_dark_hard` (#3948)
- Add `onedarker` (#3980, #4060)
...
- Add `heisenberg` (#4209)
- Add `bogster_light` (#4265)
- Update `pop-dark` (#4323)
- Update `rose_pine` (#4221)
- Add `kanagawa` (#4300)
- Add `hex_stell` and `hex_toxic` (#4367)
